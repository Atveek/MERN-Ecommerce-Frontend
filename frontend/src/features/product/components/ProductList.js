...
export default function ProductList() {
  ...
  useEffect(() => {
    const pageobj = { _page: page, _limit: ITEMS_PER_PAGE };
    dispatch(fetchProductByFiltersAsync({ filter, sort, pagination: pageobj }));
...
function Pagination({ page, handlepage, totalItems = 55 }) {
  const totalpage = Math.ceil(totalItems / ITEMS_PER_PAGE);
  return (
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      <div className="flex flex-1 justify-between sm:hidden">
        <button
          onClick={() => handlepage(page - 1 > 0 ? page - 1 : page)}
          className="relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
        >
          Previous
        </button>
        <button
          onClick={() => handlepage(page + 1 <= totalpage ? page + 1 : page)}
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          ...
          >
                ...
                <div
                  ...
                  className={`relative z-10 inline-flex items-center ${
                    index + 1 === page
                      ...
                      : "bg-white text-black"
                  } px-4 py-2 text-sm cursor-pointer  font-semibold  focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
                >
                  {index + 1}
                </div>
              );
            ...
            <button
              onClick={() =>
                handlepage(page + 1 <= totalpage ? page + 1 : page)
              }
