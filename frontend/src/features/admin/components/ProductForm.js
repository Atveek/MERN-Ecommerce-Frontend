...
export default function ProductForm() {
  ...
  useEffect(() => {
    if (selectProduct) {
      ...
      setValue("discount", selectProduct.discountPercentage);
      var count = 1;
      if (selectProduct.images) {
        for (let url of selectProduct?.images) {
          setValue(`image${count}`, url);
          count++;
        }
      }
      count = 1;
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              {selectProduct?.deleted && (
                <h2 className="text-md font-semibold leading-7 text-red-500 col-span-6">
